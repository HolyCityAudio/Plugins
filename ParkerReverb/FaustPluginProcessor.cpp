...
name: "JPverbRaw"
version: "1.1"
Code generated with Faust 2.13.15 (https://faust.grame.fr)
...
struct LibsndfileReader : public SoundfileReader {
    ...
    void readFileAux(Soundfile* soundfile, SNDFILE* snd_file, const SF_INFO& snd_info, int part, int& offset, int max_chan)
    {
        ...
        sample_read reader;
        if (soundfile->fIsDouble) {
            buffer_in = (double*)alloca(BUFFER_SIZE * sizeof(double) * snd_info.channels);
            reader = reinterpret_cast<sample_read>(sf_readf_double);
        } else {
            buffer_in = (float*)alloca(BUFFER_SIZE * sizeof(float) * snd_info.channels);
        ...
        if  (isResampling(snd_info.samplerate)) {
            ...
            if (soundfile->fIsDouble) {
                buffer_out = (double*)alloca(BUFFER_SIZE * sizeof(double) * snd_info.channels);
            } else {
                buffer_out = (float*)alloca(BUFFER_SIZE * sizeof(float) * snd_info.channels);
            }
        }
    #endif
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "jpreverb.dsp");
		...
		m->declare("name", "Julian Parker Reverb by Holy City Audio");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider1 = FAUSTFLOAT(0.70699999999999996f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("earlyDiff", &fHslider1, 0.707000017f, 0.0f, 0.99000001f, 0.00100000005f);
		ui_interface->declare(&fHslider5, "02", "");
		ui_interface->declare(&fHslider5, "style", "knob");
		ui_interface->addHorizontalSlider("size", &fHslider5, 1.0f, 0.5f, 3.0f, 0.00999999978f);
		...
		ui_interface->declare(&fHslider2, "04", "");
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->addHorizontalSlider("damp", &fHslider2, 0.0f, 0.0f, 0.999000013f, 9.99999975e-05f);
		ui_interface->declare(&fHslider0, "04", "");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("wet", &fHslider0, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->openHorizontalBox("level");
		ui_interface->declare(&fHslider11, "00", "");
		ui_interface->declare(&fHslider11, "style", "knob");
		ui_interface->addHorizontalSlider("lowX", &fHslider11, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider10, "01", "");
		ui_interface->declare(&fHslider10, "style", "knob");
		ui_interface->addHorizontalSlider("midX", &fHslider10, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider7, "02", "");
		ui_interface->declare(&fHslider7, "style", "knob");
		ui_interface->addHorizontalSlider("highX", &fHslider7, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->declare(0, "01", "");
		ui_interface->openHorizontalBox("Xover");
		ui_interface->declare(&fHslider9, "03", "");
		ui_interface->declare(&fHslider9, "style", "knob");
		ui_interface->addHorizontalSlider("lowBand", &fHslider9, 500.0f, 100.0f, 6000.0f, 0.100000001f);
		ui_interface->declare(&fHslider8, "04", "");
		ui_interface->declare(&fHslider8, "style", "knob");
		ui_interface->addHorizontalSlider("highBand", &fHslider8, 2000.0f, 1000.0f, 10000.0f, 0.100000001f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->declare(0, "03", "");
		ui_interface->openVerticalBox("Mod");
		ui_interface->openHorizontalBox("0x00");
		ui_interface->declare(&fHslider3, "00", "");
		ui_interface->declare(&fHslider3, "style", "knob");
		ui_interface->addHorizontalSlider("mDepth", &fHslider3, 0.100000001f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fHslider4, "01", "");
		ui_interface->declare(&fHslider4, "style", "knob");
		ui_interface->addHorizontalSlider("mFreq", &fHslider4, 2.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow5 = (50.0f * float(fHslider3));
		float fSlow6 = (fConst1 * float(fHslider4));
		float fSlow7 = std::sin(fSlow6);
		float fSlow8 = std::cos(fSlow6);
		float fSlow9 = float(fHslider5);
		float fSlow10 = std::pow(10.0f, (0.0f - (0.50999999f * (((1.25f * fSlow9) + -0.25f) / float(fHslider6)))));
		float fSlow11 = float(fHslider7);
		float fSlow12 = std::tan((fConst2 * float(fHslider8)));
		float fSlow13 = (1.0f / fSlow12);
		float fSlow14 = (((fSlow13 + 0.618034005f) / fSlow12) + 1.0f);
		float fSlow15 = (1.0f / fSlow14);
		float fSlow16 = mydsp_faustpower2_f(fSlow12);
		float fSlow17 = (1.0f / fSlow16);
		float fSlow18 = (1.0f / (((fSlow13 + 1.61803401f) / fSlow12) + 1.0f));
		float fSlow19 = (fSlow13 + 1.0f);
		float fSlow20 = (0.0f - (1.0f / (fSlow12 * fSlow19)));
		int iSlow21 = int(primes(int((10.0f * fSlow9))));
		float fSlow22 = (9.99999975e-05f * float(iSlow21));
		int iSlow23 = int(primes(int((110.0f * fSlow9))));
		float fSlow24 = (9.99999975e-05f * float(iSlow23));
		int iSlow25 = int(primes(int((40.0f * fSlow9))));
		float fSlow26 = (9.99999975e-05f * float(iSlow25));
		int iSlow27 = int(primes(int((140.0f * fSlow9))));
		float fSlow28 = (9.99999975e-05f * float(iSlow27));
		int iSlow29 = int(primes(int((70.0f * fSlow9))));
		float fSlow30 = (9.99999975e-05f * float(iSlow29));
		int iSlow31 = int(primes(int((170.0f * fSlow9))));
		float fSlow32 = (9.99999975e-05f * float(iSlow31));
		int iSlow33 = int(primes(int((100.0f * fSlow9))));
		float fSlow34 = (9.99999975e-05f * float(iSlow33));
		int iSlow35 = int(primes(int((200.0f * fSlow9))));
		float fSlow36 = (9.99999975e-05f * float(iSlow35));
		int iSlow37 = int(primes(int((130.0f * fSlow9))));
		float fSlow38 = (9.99999975e-05f * float(iSlow37));
		int iSlow39 = int(primes(int((230.0f * fSlow9))));
		float fSlow40 = (9.99999975e-05f * float(iSlow39));
		int iSlow41 = int(primes(int((54.0f * fSlow9))));
		float fSlow42 = (0.00499999989f * float(iSlow41));
		float fSlow43 = (0.0f - fSlow5);
		int iSlow44 = int(primes(int((204.0f * fSlow9))));
		float fSlow45 = (0.00499999989f * float(iSlow44));
		int iSlow46 = int(primes(int((125.0f * fSlow9))));
		float fSlow47 = (9.99999975e-05f * float(iSlow46));
		int iSlow48 = int(primes(int((25.0f * fSlow9))));
		float fSlow49 = (9.99999975e-05f * float(iSlow48));
		int iSlow50 = int(primes(int((155.0f * fSlow9))));
		float fSlow51 = (9.99999975e-05f * float(iSlow50));
		int iSlow52 = int(primes(int((55.0f * fSlow9))));
		float fSlow53 = (9.99999975e-05f * float(iSlow52));
		int iSlow54 = int(primes(int((185.0f * fSlow9))));
		float fSlow55 = (9.99999975e-05f * float(iSlow54));
		int iSlow56 = int(primes(int((85.0f * fSlow9))));
		float fSlow57 = (9.99999975e-05f * float(iSlow56));
		int iSlow58 = int(primes(int((215.0f * fSlow9))));
		float fSlow59 = (9.99999975e-05f * float(iSlow58));
		int iSlow60 = int(primes(int((115.0f * fSlow9))));
		float fSlow61 = (9.99999975e-05f * float(iSlow60));
		int iSlow62 = int(primes(int((245.0f * fSlow9))));
		float fSlow63 = (9.99999975e-05f * float(iSlow62));
		int iSlow64 = int(primes(int((145.0f * fSlow9))));
		float fSlow65 = (9.99999975e-05f * float(iSlow64));
		int iSlow66 = int(primes(int((134.0f * fSlow9))));
		float fSlow67 = (0.00499999989f * float(iSlow66));
		float fSlow68 = (1.0f / fSlow19);
		float fSlow69 = (1.0f - fSlow13);
		float fSlow70 = (((fSlow13 + -1.61803401f) / fSlow12) + 1.0f);
		float fSlow71 = (2.0f * (1.0f - fSlow17));
		float fSlow72 = (0.0f - (2.0f / fSlow16));
		float fSlow73 = (((fSlow13 + -0.618034005f) / fSlow12) + 1.0f);
		float fSlow74 = std::tan((fConst2 * float(fHslider9)));
		float fSlow75 = (1.0f / fSlow74);
		float fSlow76 = (1.0f / (((fSlow75 + 1.61803401f) / fSlow74) + 1.0f));
		float fSlow77 = (((fSlow75 + -1.61803401f) / fSlow74) + 1.0f);
		float fSlow78 = mydsp_faustpower2_f(fSlow74);
		float fSlow79 = (1.0f / fSlow78);
		float fSlow80 = (2.0f * (1.0f - fSlow79));
		float fSlow81 = (1.0f / (((fSlow75 + 0.618034005f) / fSlow74) + 1.0f));
		float fSlow82 = float(fHslider10);
		float fSlow83 = (1.0f / (((fSlow75 + 1.61803401f) / fSlow74) + 1.0f));
		float fSlow84 = (fSlow75 + 1.0f);
		float fSlow85 = (0.0f - (1.0f / (fSlow74 * fSlow84)));
		float fSlow86 = (1.0f / fSlow84);
		float fSlow87 = (1.0f - fSlow75);
		float fSlow88 = (1.0f / (fSlow74 * fSlow14));
		float fSlow89 = (((fSlow75 + -1.61803401f) / fSlow74) + 1.0f);
		float fSlow90 = (0.0f - (2.0f / fSlow78));
		float fSlow91 = (((fSlow75 + -0.618034005f) / fSlow74) + 1.0f);
		float fSlow92 = float(fHslider11);
		float fSlow93 = std::sin(fSlow1);
		int iSlow94 = int(primes(int((34.0f * fSlow9))));
		float fSlow95 = (0.00499999989f * float(iSlow94));
		int iSlow96 = int(primes(int((240.0f * fSlow9))));
		float fSlow97 = (9.99999975e-05f * float(iSlow96));
		int iSlow98 = int(primes(int((190.0f * fSlow9))));
		float fSlow99 = (9.99999975e-05f * float(iSlow98));
		int iSlow100 = int(primes(int((175.0f * fSlow9))));
		float fSlow101 = (9.99999975e-05f * float(iSlow100));
		float fSlow102 = (1.0f - fSlow0);
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			iVec0[0] = 1;
			fRec15[0] = ((fSlow7 * fRec16[1]) + (fSlow8 * fRec15[1]));
			int iTemp0 = (1 - iVec0[1]);
			fRec16[0] = ((float(iTemp0) + (fSlow8 * fRec16[1])) - (fSlow7 * fRec15[1]));
			float fTemp1 = (fSlow5 * (fRec15[0] + 1.0f));
			...
			float fTemp13 = ((0.760313988f * fRec0[1]) - (0.649555743f * fRec50[1]));
			float fTemp14 = ((0.760313988f * fRec1[1]) - (0.649555743f * fRec51[1]));
			fVec1[(IOTA & 16383)] = ((0.707106769f * fTemp13) - (0.707106769f * fTemp14));
			fRec53[0] = (fSlow22 + (0.999899983f * (fRec53[1] + float((iSlow21 * iTemp0)))));
			float fTemp15 = (fRec53[0] + -1.49998999f);
			float fTemp16 = fVec1[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp15)))) & 16383)];
			fVec2[0] = fTemp16;
			float fTemp17 = std::floor(fTemp15);
			fRec52[0] = (fVec2[1] - (((fTemp17 + (2.0f - fRec53[0])) * (fRec52[1] - fTemp16)) / (fRec53[0] - fTemp17)));
			fRec50[0] = fRec52[0];
			fVec3[(IOTA & 16383)] = ((0.707106769f * fTemp13) + (0.707106769f * fTemp14));
			fRec55[0] = (fSlow24 + (0.999899983f * (fRec55[1] + float((iSlow23 * iTemp0)))));
			float fTemp18 = (fRec55[0] + -1.49998999f);
			float fTemp19 = fVec3[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp18)))) & 16383)];
			fVec4[0] = fTemp19;
			float fTemp20 = std::floor(fTemp18);
			fRec54[0] = (fVec4[1] - (((fTemp20 + (2.0f - fRec55[0])) * (fRec54[1] - fTemp19)) / (fRec55[0] - fTemp20)));
			fRec51[0] = fRec54[0];
			float fTemp21 = ((0.760313988f * fRec50[1]) + (0.649555743f * fRec0[1]));
			float fTemp22 = ((0.760313988f * fTemp21) - (0.649555743f * fRec47[1]));
			float fTemp23 = ((0.760313988f * fRec51[1]) + (0.649555743f * fRec1[1]));
			float fTemp24 = ((0.760313988f * fTemp23) - (0.649555743f * fRec48[1]));
			fVec5[(IOTA & 16383)] = ((0.707106769f * fTemp22) - (0.707106769f * fTemp24));
			fRec56[0] = (fSlow26 + (0.999899983f * (fRec56[1] + float((iSlow25 * iTemp0)))));
			float fTemp25 = (fRec56[0] + -1.49998999f);
			float fTemp26 = fVec5[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp25)))) & 16383)];
			fVec6[0] = fTemp26;
			float fTemp27 = std::floor(fTemp25);
			fRec49[0] = (fVec6[1] - (((fTemp27 + (2.0f - fRec56[0])) * (fRec49[1] - fTemp26)) / (fRec56[0] - fTemp27)));
			fRec47[0] = fRec49[0];
			fVec7[(IOTA & 16383)] = ((0.707106769f * fTemp22) + (0.707106769f * fTemp24));
			fRec58[0] = (fSlow28 + (0.999899983f * (fRec58[1] + float((iSlow27 * iTemp0)))));
			float fTemp28 = (fRec58[0] + -1.49998999f);
			float fTemp29 = fVec7[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp28)))) & 16383)];
			fVec8[0] = fTemp29;
			float fTemp30 = std::floor(fTemp28);
			fRec57[0] = (fVec8[1] - (((fTemp30 + (2.0f - fRec58[0])) * (fRec57[1] - fTemp29)) / (fRec58[0] - fTemp30)));
			fRec48[0] = fRec57[0];
			float fTemp31 = ((0.760313988f * fRec47[1]) + (0.649555743f * fTemp21));
			float fTemp32 = ((0.760313988f * fTemp31) - (0.649555743f * fRec44[1]));
			float fTemp33 = ((0.760313988f * fRec48[1]) + (0.649555743f * fTemp23));
			float fTemp34 = ((0.760313988f * fTemp33) - (0.649555743f * fRec45[1]));
			fVec9[(IOTA & 16383)] = ((0.707106769f * fTemp32) - (0.707106769f * fTemp34));
			fRec59[0] = (fSlow30 + (0.999899983f * (fRec59[1] + float((iSlow29 * iTemp0)))));
			float fTemp35 = (fRec59[0] + -1.49998999f);
			float fTemp36 = fVec9[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp35)))) & 16383)];
			fVec10[0] = fTemp36;
			float fTemp37 = std::floor(fTemp35);
			fRec46[0] = (fVec10[1] - (((fTemp37 + (2.0f - fRec59[0])) * (fRec46[1] - fTemp36)) / (fRec59[0] - fTemp37)));
			fRec44[0] = fRec46[0];
			fVec11[(IOTA & 16383)] = ((0.707106769f * fTemp32) + (0.707106769f * fTemp34));
			fRec61[0] = (fSlow32 + (0.999899983f * (fRec61[1] + float((iSlow31 * iTemp0)))));
			float fTemp38 = (fRec61[0] + -1.49998999f);
			float fTemp39 = fVec11[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp38)))) & 16383)];
			fVec12[0] = fTemp39;
			float fTemp40 = std::floor(fTemp38);
			fRec60[0] = (fVec12[1] - (((fTemp40 + (2.0f - fRec61[0])) * (fRec60[1] - fTemp39)) / (fRec61[0] - fTemp40)));
			fRec45[0] = fRec60[0];
			float fTemp41 = ((0.760313988f * fRec44[1]) + (0.649555743f * fTemp31));
			float fTemp42 = ((0.760313988f * fTemp41) - (0.649555743f * fRec41[1]));
			float fTemp43 = ((0.760313988f * fRec45[1]) + (0.649555743f * fTemp33));
			float fTemp44 = ((0.760313988f * fTemp43) - (0.649555743f * fRec42[1]));
			fVec13[(IOTA & 16383)] = ((0.707106769f * fTemp42) - (0.707106769f * fTemp44));
			fRec62[0] = (fSlow34 + (0.999899983f * (fRec62[1] + float((iSlow33 * iTemp0)))));
			float fTemp45 = (fRec62[0] + -1.49998999f);
			float fTemp46 = fVec13[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp45)))) & 16383)];
			fVec14[0] = fTemp46;
			float fTemp47 = std::floor(fTemp45);
			fRec43[0] = (fVec14[1] - (((fTemp47 + (2.0f - fRec62[0])) * (fRec43[1] - fTemp46)) / (fRec62[0] - fTemp47)));
			fRec41[0] = fRec43[0];
			fVec15[(IOTA & 16383)] = ((0.707106769f * fTemp42) + (0.707106769f * fTemp44));
			fRec64[0] = (fSlow36 + (0.999899983f * (fRec64[1] + float((iSlow35 * iTemp0)))));
			float fTemp48 = (fRec64[0] + -1.49998999f);
			float fTemp49 = fVec15[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp48)))) & 16383)];
			fVec16[0] = fTemp49;
			float fTemp50 = std::floor(fTemp48);
			fRec63[0] = (fVec16[1] - (((fTemp50 + (2.0f - fRec64[0])) * (fRec63[1] - fTemp49)) / (fRec64[0] - fTemp50)));
			fRec42[0] = fRec63[0];
			float fTemp51 = ((0.760313988f * fRec41[1]) + (0.649555743f * fTemp41));
			float fTemp52 = ((0.760313988f * fTemp51) - (0.649555743f * fRec38[1]));
			float fTemp53 = ((0.760313988f * fRec42[1]) + (0.649555743f * fTemp43));
			float fTemp54 = ((0.760313988f * fTemp53) - (0.649555743f * fRec39[1]));
			fVec17[(IOTA & 16383)] = ((0.707106769f * fTemp52) - (0.707106769f * fTemp54));
			fRec65[0] = (fSlow38 + (0.999899983f * (fRec65[1] + float((iSlow37 * iTemp0)))));
			float fTemp55 = (fRec65[0] + -1.49998999f);
			float fTemp56 = fVec17[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp55)))) & 16383)];
			fVec18[0] = fTemp56;
			float fTemp57 = std::floor(fTemp55);
			fRec40[0] = (fVec18[1] - (((fTemp57 + (2.0f - fRec65[0])) * (fRec40[1] - fTemp56)) / (fRec65[0] - fTemp57)));
			fRec38[0] = fRec40[0];
			fVec19[(IOTA & 16383)] = ((0.707106769f * fTemp52) + (0.707106769f * fTemp54));
			fRec67[0] = (fSlow40 + (0.999899983f * (fRec67[1] + float((iSlow39 * iTemp0)))));
			float fTemp58 = (fRec67[0] + -1.49998999f);
			float fTemp59 = fVec19[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp58)))) & 16383)];
			fVec20[0] = fTemp59;
			float fTemp60 = std::floor(fTemp58);
			fRec66[0] = (fVec20[1] - (((fTemp60 + (2.0f - fRec67[0])) * (fRec66[1] - fTemp59)) / (fRec67[0] - fTemp60)));
			fRec39[0] = fRec66[0];
			float fTemp61 = ((0.760313988f * fRec38[1]) + (0.649555743f * fTemp51));
			fVec21[(IOTA & 1023)] = fTemp61;
			float fTemp62 = (fSlow5 * (fRec16[0] + 1.0f));
			float fTemp63 = (fTemp62 + 3.50000501f);
			int iTemp64 = int(fTemp63);
			int iTemp65 = std::min<int>(512, std::max<int>(0, iTemp64));
			float fTemp66 = std::floor(fTemp63);
			float fTemp67 = (fTemp62 + (4.0f - fTemp66));
			float fTemp68 = (0.0f - fTemp67);
			float fTemp69 = (fTemp62 + (3.0f - fTemp66));
			float fTemp70 = (0.0f - (0.5f * fTemp69));
			float fTemp71 = (fTemp62 + (2.0f - fTemp66));
			float fTemp72 = (0.0f - (0.333333343f * fTemp71));
			float fTemp73 = (fTemp62 + (1.0f - fTemp66));
			float fTemp74 = (0.0f - (0.25f * fTemp73));
			float fTemp75 = (fTemp62 + (5.0f - fTemp66));
			int iTemp76 = std::min<int>(512, std::max<int>(0, (iTemp64 + 1)));
			float fTemp77 = (0.0f - fTemp69);
			float fTemp78 = (0.0f - (0.5f * fTemp71));
			float fTemp79 = (0.0f - (0.333333343f * fTemp73));
			int iTemp80 = std::min<int>(512, std::max<int>(0, (iTemp64 + 2)));
			float fTemp81 = (0.0f - fTemp71);
			float fTemp82 = (0.0f - (0.5f * fTemp73));
			float fTemp83 = (fTemp67 * fTemp69);
			int iTemp84 = std::min<int>(512, std::max<int>(0, (iTemp64 + 3)));
			float fTemp85 = (0.0f - fTemp73);
			float fTemp86 = (fTemp83 * fTemp71);
			int iTemp87 = std::min<int>(512, std::max<int>(0, (iTemp64 + 4)));
			fVec22[(IOTA & 16383)] = (((((fVec21[((IOTA - iTemp65) & 1023)] * fTemp68) * fTemp70) * fTemp72) * fTemp74) + (fTemp75 * ((((((fVec21[((IOTA - iTemp76) & 1023)] * fTemp77) * fTemp78) * fTemp79) + (0.5f * (((fTemp67 * fVec21[((IOTA - iTemp80) & 1023)]) * fTemp81) * fTemp82))) + (0.166666672f * ((fTemp83 * fVec21[((IOTA - iTemp84) & 1023)]) * fTemp85))) + (0.0416666679f * (fTemp86 * fVec21[((IOTA - iTemp87) & 1023)])))));
			fRec68[0] = (fSlow42 + (0.995000005f * (fRec68[1] + float((iSlow41 * iTemp0)))));
			float fTemp88 = (fRec68[0] + -1.49998999f);
			float fTemp89 = fVec22[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp88)))) & 16383)];
			fVec23[0] = fTemp89;
			float fTemp90 = std::floor(fTemp88);
			fRec37[0] = (fVec23[1] - (((fTemp90 + (2.0f - fRec68[0])) * (fRec37[1] - fTemp89)) / (fRec68[0] - fTemp90)));
			float fTemp91 = ((0.760313988f * fRec37[0]) - (0.649555743f * fRec34[1]));
			float fTemp92 = ((0.760313988f * fRec39[1]) + (0.649555743f * fTemp53));
			fVec24[(IOTA & 1023)] = fTemp92;
			float fTemp93 = (fSlow43 * fRec16[0]);
			float fTemp94 = (fSlow5 + (fTemp93 + 3.50000501f));
			int iTemp95 = int(fTemp94);
			float fTemp96 = std::floor(fTemp94);
			float fTemp97 = (fSlow5 + (fTemp93 + (4.0f - fTemp96)));
			float fTemp98 = (fSlow5 + (fTemp93 + (3.0f - fTemp96)));
			float fTemp99 = (fSlow5 + (fTemp93 + (2.0f - fTemp96)));
			float fTemp100 = (fSlow5 + (fTemp93 + (1.0f - fTemp96)));
			float fTemp101 = (fTemp97 * fTemp98);
			fVec25[(IOTA & 16383)] = (((((fVec24[((IOTA - std::min<int>(512, std::max<int>(0, iTemp95))) & 1023)] * (0.0f - fTemp97)) * (0.0f - (0.5f * fTemp98))) * (0.0f - (0.333333343f * fTemp99))) * (0.0f - (0.25f * fTemp100))) + ((fSlow5 + (fTemp93 + (5.0f - fTemp96))) * ((((((fVec24[((IOTA - std::min<int>(512, std::max<int>(0, (iTemp95 + 1)))) & 1023)] * (0.0f - fTemp98)) * (0.0f - (0.5f * fTemp99))) * (0.0f - (0.333333343f * fTemp100))) + (0.5f * (((fTemp97 * fVec24[((IOTA - std::min<int>(512, std::max<int>(0, (iTemp95 + 2)))) & 1023)]) * (0.0f - fTemp99)) * (0.0f - (0.5f * fTemp100))))) + (0.166666672f * ((fTemp101 * fVec24[((IOTA - std::min<int>(512, std::max<int>(0, (iTemp95 + 3)))) & 1023)]) * (0.0f - fTemp100)))) + (0.0416666679f * ((fTemp101 * fTemp99) * fVec24[((IOTA - std::min<int>(512, std::max<int>(0, (iTemp95 + 4)))) & 1023)])))));
			fRec70[0] = (fSlow45 + (0.995000005f * (fRec70[1] + float((iSlow44 * iTemp0)))));
			float fTemp102 = (fRec70[0] + -1.49998999f);
			float fTemp103 = fVec25[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp102)))) & 16383)];
			fVec26[0] = fTemp103;
			float fTemp104 = std::floor(fTemp102);
			fRec69[0] = (fVec26[1] - (((fTemp104 + (2.0f - fRec70[0])) * (fRec69[1] - fTemp103)) / (fRec70[0] - fTemp104)));
			float fTemp105 = ((0.760313988f * fRec69[0]) - (0.649555743f * fRec35[1]));
			fVec27[(IOTA & 16383)] = ((0.707106769f * fTemp91) - (0.707106769f * fTemp105));
			fRec71[0] = (fSlow47 + (0.999899983f * (fRec71[1] + float((iSlow46 * iTemp0)))));
			float fTemp106 = (fRec71[0] + -1.49998999f);
			float fTemp107 = fVec27[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp106)))) & 16383)];
			fVec28[0] = fTemp107;
			float fTemp108 = std::floor(fTemp106);
			fRec36[0] = (fVec28[1] - (((fTemp108 + (2.0f - fRec71[0])) * (fRec36[1] - fTemp107)) / (fRec71[0] - fTemp108)));
			fRec34[0] = fRec36[0];
			fVec29[(IOTA & 16383)] = ((0.707106769f * fTemp91) + (0.707106769f * fTemp105));
			fRec73[0] = (fSlow49 + (0.999899983f * (fRec73[1] + float((iSlow48 * iTemp0)))));
			float fTemp109 = (fRec73[0] + -1.49998999f);
			float fTemp110 = fVec29[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp109)))) & 16383)];
			fVec30[0] = fTemp110;
			float fTemp111 = std::floor(fTemp109);
			fRec72[0] = (fVec30[1] - (((fTemp111 + (2.0f - fRec73[0])) * (fRec72[1] - fTemp110)) / (fRec73[0] - fTemp111)));
			fRec35[0] = fRec72[0];
			float fTemp112 = ((0.760313988f * fRec34[1]) + (0.649555743f * fRec37[0]));
			float fTemp113 = ((0.760313988f * fTemp112) - (0.649555743f * fRec31[1]));
			float fTemp114 = ((0.760313988f * fRec35[1]) + (0.649555743f * fRec69[0]));
			float fTemp115 = ((0.760313988f * fTemp114) - (0.649555743f * fRec32[1]));
			fVec31[(IOTA & 16383)] = ((0.707106769f * fTemp113) - (0.707106769f * fTemp115));
			fRec74[0] = (fSlow51 + (0.999899983f * (fRec74[1] + float((iSlow50 * iTemp0)))));
			float fTemp116 = (fRec74[0] + -1.49998999f);
			float fTemp117 = fVec31[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp116)))) & 16383)];
			fVec32[0] = fTemp117;
			float fTemp118 = std::floor(fTemp116);
			fRec33[0] = (fVec32[1] - (((fTemp118 + (2.0f - fRec74[0])) * (fRec33[1] - fTemp117)) / (fRec74[0] - fTemp118)));
			fRec31[0] = fRec33[0];
			fVec33[(IOTA & 16383)] = ((0.707106769f * fTemp113) + (0.707106769f * fTemp115));
			fRec76[0] = (fSlow53 + (0.999899983f * (fRec76[1] + float((iSlow52 * iTemp0)))));
			float fTemp119 = (fRec76[0] + -1.49998999f);
			int iTemp120 = std::min<int>(8192, std::max<int>(0, int(fTemp119)));
			float fTemp121 = fVec33[((IOTA - iTemp120) & 16383)];
			fVec34[0] = fTemp121;
			float fTemp122 = std::floor(fTemp119);
			float fTemp123 = (fTemp122 + (2.0f - fRec76[0]));
			float fTemp124 = (fRec76[0] - fTemp122);
			fRec75[0] = (fVec34[1] - ((fTemp123 * (fRec75[1] - fTemp121)) / fTemp124));
			fRec32[0] = fRec75[0];
			float fTemp125 = ((0.760313988f * fRec31[1]) + (0.649555743f * fTemp112));
			float fTemp126 = ((0.760313988f * fTemp125) - (0.649555743f * fRec28[1]));
			float fTemp127 = ((0.760313988f * fRec32[1]) + (0.649555743f * fTemp114));
			float fTemp128 = ((0.760313988f * fTemp127) - (0.649555743f * fRec29[1]));
			fVec35[(IOTA & 16383)] = ((0.707106769f * fTemp126) - (0.707106769f * fTemp128));
			fRec77[0] = (fSlow55 + (0.999899983f * (fRec77[1] + float((iSlow54 * iTemp0)))));
			float fTemp129 = (fRec77[0] + -1.49998999f);
			float fTemp130 = fVec35[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp129)))) & 16383)];
			fVec36[0] = fTemp130;
			float fTemp131 = std::floor(fTemp129);
			fRec30[0] = (fVec36[1] - (((fTemp131 + (2.0f - fRec77[0])) * (fRec30[1] - fTemp130)) / (fRec77[0] - fTemp131)));
			fRec28[0] = fRec30[0];
			fVec37[(IOTA & 16383)] = ((0.707106769f * fTemp126) + (0.707106769f * fTemp128));
			fRec79[0] = (fSlow57 + (0.999899983f * (fRec79[1] + float((iSlow56 * iTemp0)))));
			float fTemp132 = (fRec79[0] + -1.49998999f);
			int iTemp133 = std::min<int>(8192, std::max<int>(0, int(fTemp132)));
			float fTemp134 = fVec37[((IOTA - iTemp133) & 16383)];
			fVec38[0] = fTemp134;
			float fTemp135 = std::floor(fTemp132);
			float fTemp136 = (fTemp135 + (2.0f - fRec79[0]));
			float fTemp137 = (fRec79[0] - fTemp135);
			fRec78[0] = (fVec38[1] - ((fTemp136 * (fRec78[1] - fTemp134)) / fTemp137));
			fRec29[0] = fRec78[0];
			float fTemp138 = ((0.760313988f * fRec28[1]) + (0.649555743f * fTemp125));
			float fTemp139 = ((0.760313988f * fTemp138) - (0.649555743f * fRec25[1]));
			float fTemp140 = ((0.760313988f * fRec29[1]) + (0.649555743f * fTemp127));
			float fTemp141 = ((0.760313988f * fTemp140) - (0.649555743f * fRec26[1]));
			fVec39[(IOTA & 16383)] = ((0.707106769f * fTemp139) - (0.707106769f * fTemp141));
			fRec80[0] = (fSlow59 + (0.999899983f * (fRec80[1] + float((iSlow58 * iTemp0)))));
			float fTemp142 = (fRec80[0] + -1.49998999f);
			int iTemp143 = std::min<int>(8192, std::max<int>(0, int(fTemp142)));
			float fTemp144 = fVec39[((IOTA - iTemp143) & 16383)];
			fVec40[0] = fTemp144;
			float fTemp145 = std::floor(fTemp142);
			float fTemp146 = (fTemp145 + (2.0f - fRec80[0]));
			float fTemp147 = (fRec80[0] - fTemp145);
			fRec27[0] = (fVec40[1] - ((fTemp146 * (fRec27[1] - fTemp144)) / fTemp147));
			fRec25[0] = fRec27[0];
			fVec41[(IOTA & 16383)] = ((0.707106769f * fTemp139) + (0.707106769f * fTemp141));
			fRec82[0] = (fSlow61 + (0.999899983f * (fRec82[1] + float((iSlow60 * iTemp0)))));
			float fTemp148 = (fRec82[0] + -1.49998999f);
			int iTemp149 = std::min<int>(8192, std::max<int>(0, int(fTemp148)));
			float fTemp150 = fVec41[((IOTA - iTemp149) & 16383)];
			fVec42[0] = fTemp150;
			float fTemp151 = std::floor(fTemp148);
			float fTemp152 = (fTemp151 + (2.0f - fRec82[0]));
			float fTemp153 = (fRec82[0] - fTemp151);
			fRec81[0] = (fVec42[1] - ((fTemp152 * (fRec81[1] - fTemp150)) / fTemp153));
			fRec26[0] = fRec81[0];
			float fTemp154 = ((0.760313988f * fRec25[1]) + (0.649555743f * fTemp138));
			float fTemp155 = ((0.760313988f * fTemp154) - (0.649555743f * fRec22[1]));
			float fTemp156 = ((0.760313988f * fRec26[1]) + (0.649555743f * fTemp140));
			float fTemp157 = ((0.760313988f * fTemp156) - (0.649555743f * fRec23[1]));
			fVec43[(IOTA & 16383)] = ((0.707106769f * fTemp155) - (0.707106769f * fTemp157));
			fRec83[0] = (fSlow63 + (0.999899983f * (fRec83[1] + float((iSlow62 * iTemp0)))));
			float fTemp158 = (fRec83[0] + -1.49998999f);
			float fTemp159 = fVec43[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp158)))) & 16383)];
			fVec44[0] = fTemp159;
			float fTemp160 = std::floor(fTemp158);
			fRec24[0] = (fVec44[1] - (((fTemp160 + (2.0f - fRec83[0])) * (fRec24[1] - fTemp159)) / (fRec83[0] - fTemp160)));
			fRec22[0] = fRec24[0];
			fVec45[(IOTA & 16383)] = ((0.707106769f * fTemp155) + (0.707106769f * fTemp157));
			fRec85[0] = (fSlow65 + (0.999899983f * (fRec85[1] + float((iSlow64 * iTemp0)))));
			float fTemp161 = (fRec85[0] + -1.49998999f);
			int iTemp162 = std::min<int>(8192, std::max<int>(0, int(fTemp161)));
			float fTemp163 = fVec45[((IOTA - iTemp162) & 16383)];
			fVec46[0] = fTemp163;
			float fTemp164 = std::floor(fTemp161);
			float fTemp165 = (fTemp164 + (2.0f - fRec85[0]));
			float fTemp166 = (fRec85[0] - fTemp164);
			fRec84[0] = (fVec46[1] - ((fTemp165 * (fRec84[1] - fTemp163)) / fTemp166));
			fRec23[0] = fRec84[0];
			float fTemp167 = ((0.760313988f * fRec22[1]) + (0.649555743f * fTemp154));
			fVec47[(IOTA & 16383)] = fTemp167;
			int iTemp168 = int(fTemp2);
			int iTemp169 = std::max<int>(0, iTemp168);
			float fTemp170 = (fTemp1 + (5.0f - fTemp3));
			int iTemp171 = std::max<int>(0, (iTemp168 + 1));
			float fTemp172 = (0.0f - fTemp6);
			float fTemp173 = (0.0f - (0.5f * fTemp8));
			float fTemp174 = (0.0f - (0.333333343f * fTemp10));
			int iTemp175 = std::max<int>(0, (iTemp168 + 2));
			float fTemp176 = (0.0f - fTemp8);
			float fTemp177 = (0.0f - (0.5f * fTemp10));
			float fTemp178 = (fTemp4 * fTemp6);
			int iTemp179 = std::max<int>(0, (iTemp168 + 3));
			float fTemp180 = (0.0f - fTemp10);
			float fTemp181 = (fTemp178 * fTemp8);
			int iTemp182 = std::max<int>(0, (iTemp168 + 4));
			fVec48[(IOTA & 16383)] = (((((fVec47[((IOTA - std::min<int>(8192, iTemp169)) & 16383)] * fTemp5) * fTemp7) * fTemp9) * fTemp11) + (fTemp170 * ((((((fVec47[((IOTA - std::min<int>(8192, iTemp171)) & 16383)] * fTemp172) * fTemp173) * fTemp174) + (0.5f * (((fTemp4 * fVec47[((IOTA - std::min<int>(8192, iTemp175)) & 16383)]) * fTemp176) * fTemp177))) + (0.166666672f * ((fTemp178 * fVec47[((IOTA - std::min<int>(8192, iTemp179)) & 16383)]) * fTemp180))) + (0.0416666679f * (fTemp181 * fVec47[((IOTA - std::min<int>(8192, iTemp182)) & 16383)])))));
			fRec86[0] = (fSlow67 + (0.995000005f * (fRec86[1] + float((iSlow66 * iTemp0)))));
			float fTemp183 = (fRec86[0] + -1.49998999f);
			float fTemp184 = fVec48[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp183)))) & 16383)];
			fVec49[0] = fTemp184;
			float fTemp185 = std::floor(fTemp183);
			fRec21[0] = (fVec49[1] - (((fTemp185 + (2.0f - fRec86[0])) * (fRec21[1] - fTemp184)) / (fRec86[0] - fTemp185)));
			fRec20[0] = ((fSlow20 * fRec21[1]) - (fSlow68 * ((fSlow69 * fRec20[1]) - (fSlow13 * fRec21[0]))));
			fRec19[0] = (fRec20[0] - (fSlow18 * ((fSlow70 * fRec19[2]) + (fSlow71 * fRec19[1]))));
			fRec18[0] = ((fSlow18 * (((fSlow17 * fRec19[0]) + (fSlow72 * fRec19[1])) + (fSlow17 * fRec19[2]))) - (fSlow15 * ((fSlow73 * fRec18[2]) + (fSlow71 * fRec18[1]))));
			float fTemp186 = (fSlow80 * fRec17[1]);
			fRec17[0] = ((fSlow15 * (((fSlow17 * fRec18[0]) + (fSlow72 * fRec18[1])) + (fSlow17 * fRec18[2]))) - (fSlow76 * ((fSlow77 * fRec17[2]) + fTemp186)));
			fRec92[0] = (0.0f - (fSlow68 * ((fSlow69 * fRec92[1]) - (fRec21[0] + fRec21[1]))));
			fRec91[0] = (fRec92[0] - (fSlow18 * ((fSlow70 * fRec91[2]) + (fSlow71 * fRec91[1]))));
			fRec90[0] = ((fSlow18 * (fRec91[2] + (fRec91[0] + (2.0f * fRec91[1])))) - (fSlow15 * ((fSlow73 * fRec90[2]) + (fSlow71 * fRec90[1]))));
			float fTemp187 = (fRec90[2] + (fRec90[0] + (2.0f * fRec90[1])));
			float fTemp188 = (fSlow15 * fTemp187);
			fVec50[0] = fTemp188;
			fRec89[0] = ((fSlow85 * fVec50[1]) - (fSlow86 * ((fSlow87 * fRec89[1]) - (fSlow88 * fTemp187))));
			fRec88[0] = (fRec89[0] - (fSlow83 * ((fSlow89 * fRec88[2]) + (fSlow80 * fRec88[1]))));
			fRec87[0] = ((fSlow83 * (((fSlow79 * fRec88[0]) + (fSlow90 * fRec88[1])) + (fSlow79 * fRec88[2]))) - (fSlow81 * ((fSlow91 * fRec87[2]) + (fSlow80 * fRec87[1]))));
			fRec95[0] = (0.0f - (fSlow86 * ((fSlow87 * fRec95[1]) - (fTemp188 + fVec50[1]))));
			fRec94[0] = (fRec95[0] - (fSlow83 * ((fSlow89 * fRec94[2]) + (fSlow80 * fRec94[1]))));
			fRec93[0] = ((fSlow83 * (fRec94[2] + (fRec94[0] + (2.0f * fRec94[1])))) - (fSlow81 * ((fSlow91 * fRec93[2]) + (fSlow80 * fRec93[1]))));
			float fTemp189 = (fTemp12 + (fSlow10 * ((fSlow11 * (fRec17[2] + (fSlow76 * (fTemp186 + (fSlow77 * fRec17[0]))))) + (fSlow81 * ((fSlow82 * (((fSlow79 * fRec87[0]) + (fSlow90 * fRec87[1])) + (fSlow79 * fRec87[2]))) + (fSlow92 * (fRec93[2] + (fRec93[0] + (2.0f * fRec93[1])))))))));
			fVec51[(IOTA & 1023)] = fTemp189;
			fRec14[0] = ((fSlow3 * fRec14[1]) + (fSlow4 * (((((fTemp5 * fTemp7) * fTemp9) * fTemp11) * fVec51[((IOTA - std::min<int>(512, iTemp169)) & 1023)]) + (fTemp170 * ((((((fTemp172 * fTemp173) * fTemp174) * fVec51[((IOTA - std::min<int>(512, iTemp171)) & 1023)]) + (0.5f * (((fTemp4 * fTemp176) * fTemp177) * fVec51[((IOTA - std::min<int>(512, iTemp175)) & 1023)]))) + (0.166666672f * ((fTemp178 * fTemp180) * fVec51[((IOTA - std::min<int>(512, iTemp179)) & 1023)]))) + (0.0416666679f * (fTemp181 * fVec51[((IOTA - std::min<int>(512, iTemp182)) & 1023)])))))));
			float fTemp190 = ((fSlow2 * fRec14[0]) - (fSlow93 * fRec11[1]));
			float fTemp191 = float(input1[i0]);
			float fTemp192 = ((0.760313988f * fRec23[1]) + (0.649555743f * fTemp156));
			fVec52[(IOTA & 16383)] = fTemp192;
			float fTemp193 = (fSlow43 * fRec15[0]);
			float fTemp194 = (fSlow5 + (fTemp193 + 3.50000501f));
			int iTemp195 = int(fTemp194);
			float fTemp196 = std::floor(fTemp194);
			float fTemp197 = (fSlow5 + (fTemp193 + (4.0f - fTemp196)));
			float fTemp198 = (fSlow5 + (fTemp193 + (3.0f - fTemp196)));
			float fTemp199 = (fSlow5 + (fTemp193 + (2.0f - fTemp196)));
			float fTemp200 = (fSlow5 + (fTemp193 + (1.0f - fTemp196)));
			float fTemp201 = (fTemp197 * fTemp198);
			fVec53[(IOTA & 16383)] = (((((fVec52[((IOTA - std::min<int>(8192, std::max<int>(0, iTemp195))) & 16383)] * (0.0f - fTemp197)) * (0.0f - (0.5f * fTemp198))) * (0.0f - (0.333333343f * fTemp199))) * (0.0f - (0.25f * fTemp200))) + ((fSlow5 + (fTemp193 + (5.0f - fTemp196))) * ((((((fVec52[((IOTA - std::min<int>(8192, std::max<int>(0, (iTemp195 + 1)))) & 16383)] * (0.0f - fTemp198)) * (0.0f - (0.5f * fTemp199))) * (0.0f - (0.333333343f * fTemp200))) + (0.5f * (((fTemp197 * fVec52[((IOTA - std::min<int>(8192, std::max<int>(0, (iTemp195 + 2)))) & 16383)]) * (0.0f - fTemp199)) * (0.0f - (0.5f * fTemp200))))) + (0.166666672f * ((fTemp201 * fVec52[((IOTA - std::min<int>(8192, std::max<int>(0, (iTemp195 + 3)))) & 16383)]) * (0.0f - fTemp200)))) + (0.0416666679f * ((fTemp201 * fTemp199) * fVec52[((IOTA - std::min<int>(8192, std::max<int>(0, (iTemp195 + 4)))) & 16383)])))));
			fRec102[0] = (fSlow95 + (0.995000005f * (fRec102[1] + float((iSlow94 * iTemp0)))));
			float fTemp202 = (fRec102[0] + -1.49998999f);
			float fTemp203 = fVec53[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp202)))) & 16383)];
			fVec54[0] = fTemp203;
			float fTemp204 = std::floor(fTemp202);
			fRec101[0] = (fVec54[1] - (((fTemp204 + (2.0f - fRec102[0])) * (fRec101[1] - fTemp203)) / (fRec102[0] - fTemp204)));
			fRec100[0] = ((fSlow20 * fRec101[1]) - (fSlow68 * ((fSlow69 * fRec100[1]) - (fSlow13 * fRec101[0]))));
			fRec99[0] = (fRec100[0] - (fSlow18 * ((fSlow70 * fRec99[2]) + (fSlow71 * fRec99[1]))));
			fRec98[0] = ((fSlow18 * (((fSlow17 * fRec99[0]) + (fSlow72 * fRec99[1])) + (fSlow17 * fRec99[2]))) - (fSlow15 * ((fSlow73 * fRec98[2]) + (fSlow71 * fRec98[1]))));
			float fTemp205 = (fSlow80 * fRec97[1]);
			fRec97[0] = ((fSlow15 * (((fSlow17 * fRec98[0]) + (fSlow72 * fRec98[1])) + (fSlow17 * fRec98[2]))) - (fSlow76 * ((fSlow77 * fRec97[2]) + fTemp205)));
			fRec108[0] = (0.0f - (fSlow68 * ((fSlow69 * fRec108[1]) - (fRec101[0] + fRec101[1]))));
			fRec107[0] = (fRec108[0] - (fSlow18 * ((fSlow70 * fRec107[2]) + (fSlow71 * fRec107[1]))));
			fRec106[0] = ((fSlow18 * (fRec107[2] + (fRec107[0] + (2.0f * fRec107[1])))) - (fSlow15 * ((fSlow73 * fRec106[2]) + (fSlow71 * fRec106[1]))));
			float fTemp206 = (fRec106[2] + (fRec106[0] + (2.0f * fRec106[1])));
			float fTemp207 = (fSlow15 * fTemp206);
			fVec55[0] = fTemp207;
			fRec105[0] = ((fSlow85 * fVec55[1]) - (fSlow86 * ((fSlow87 * fRec105[1]) - (fSlow88 * fTemp206))));
			fRec104[0] = (fRec105[0] - (fSlow83 * ((fSlow89 * fRec104[2]) + (fSlow80 * fRec104[1]))));
			fRec103[0] = ((fSlow83 * (((fSlow79 * fRec104[0]) + (fSlow90 * fRec104[1])) + (fSlow79 * fRec104[2]))) - (fSlow81 * ((fSlow91 * fRec103[2]) + (fSlow80 * fRec103[1]))));
			fRec111[0] = (0.0f - (fSlow86 * ((fSlow87 * fRec111[1]) - (fTemp207 + fVec55[1]))));
			fRec110[0] = (fRec111[0] - (fSlow83 * ((fSlow89 * fRec110[2]) + (fSlow80 * fRec110[1]))));
			fRec109[0] = ((fSlow83 * (fRec110[2] + (fRec110[0] + (2.0f * fRec110[1])))) - (fSlow81 * ((fSlow91 * fRec109[2]) + (fSlow80 * fRec109[1]))));
			float fTemp208 = (fTemp191 + (fSlow10 * ((fSlow11 * (fRec97[2] + (fSlow76 * (fTemp205 + (fSlow77 * fRec97[0]))))) + (fSlow81 * ((fSlow82 * (((fSlow79 * fRec103[0]) + (fSlow90 * fRec103[1])) + (fSlow79 * fRec103[2]))) + (fSlow92 * (fRec109[2] + (fRec109[0] + (2.0f * fRec109[1])))))))));
			fVec56[(IOTA & 1023)] = fTemp208;
			fRec96[0] = ((fSlow3 * fRec96[1]) + (fSlow4 * (((((fTemp68 * fTemp70) * fTemp72) * fTemp74) * fVec56[((IOTA - iTemp65) & 1023)]) + (fTemp75 * ((((((fTemp77 * fTemp78) * fTemp79) * fVec56[((IOTA - iTemp76) & 1023)]) + (0.5f * (((fTemp67 * fTemp81) * fTemp82) * fVec56[((IOTA - iTemp80) & 1023)]))) + (0.166666672f * ((fTemp83 * fTemp85) * fVec56[((IOTA - iTemp84) & 1023)]))) + (0.0416666679f * (fTemp86 * fVec56[((IOTA - iTemp87) & 1023)])))))));
			float fTemp209 = ((fSlow2 * fRec96[0]) - (fSlow93 * fRec12[1]));
			fVec57[(IOTA & 16383)] = ((0.707106769f * fTemp190) - (0.707106769f * fTemp209));
			float fTemp210 = fVec57[((IOTA - iTemp120) & 16383)];
			fVec58[0] = fTemp210;
			fRec13[0] = (fVec58[1] - ((fTemp123 * (fRec13[1] - fTemp210)) / fTemp124));
			fRec11[0] = fRec13[0];
			fVec59[(IOTA & 16383)] = ((0.707106769f * fTemp190) + (0.707106769f * fTemp209));
			fRec113[0] = (fSlow97 + (0.999899983f * (fRec113[1] + float((iSlow96 * iTemp0)))));
			float fTemp211 = (fRec113[0] + -1.49998999f);
			float fTemp212 = fVec59[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp211)))) & 16383)];
			fVec60[0] = fTemp212;
			float fTemp213 = std::floor(fTemp211);
			fRec112[0] = (fVec60[1] - (((fTemp213 + (2.0f - fRec113[0])) * (fRec112[1] - fTemp212)) / (fRec113[0] - fTemp213)));
			fRec12[0] = fRec112[0];
			float fTemp214 = ((fSlow2 * fRec11[1]) + (fSlow93 * fRec14[0]));
			float fTemp215 = ((fSlow2 * fTemp214) - (fSlow93 * fRec8[1]));
			float fTemp216 = ((fSlow2 * fRec12[1]) + (fSlow93 * fRec96[0]));
			float fTemp217 = ((fSlow2 * fTemp216) - (fSlow93 * fRec9[1]));
			fVec61[(IOTA & 16383)] = ((0.707106769f * fTemp215) - (0.707106769f * fTemp217));
			float fTemp218 = fVec61[((IOTA - iTemp143) & 16383)];
			fVec62[0] = fTemp218;
			fRec10[0] = (fVec62[1] - ((fTemp146 * (fRec10[1] - fTemp218)) / fTemp147));
			fRec8[0] = fRec10[0];
			fVec63[(IOTA & 16383)] = ((0.707106769f * fTemp215) + (0.707106769f * fTemp217));
			float fTemp219 = fVec63[((IOTA - iTemp133) & 16383)];
			fVec64[0] = fTemp219;
			fRec114[0] = (fVec64[1] - ((fTemp136 * (fRec114[1] - fTemp219)) / fTemp137));
			fRec9[0] = fRec114[0];
			float fTemp220 = ((fSlow2 * fRec8[1]) + (fSlow93 * fTemp214));
			float fTemp221 = ((fSlow2 * fTemp220) - (fSlow93 * fRec5[1]));
			float fTemp222 = ((fSlow2 * fRec9[1]) + (fSlow93 * fTemp216));
			float fTemp223 = ((fSlow2 * fTemp222) - (fSlow93 * fRec6[1]));
			fVec65[(IOTA & 16383)] = ((0.707106769f * fTemp221) - (0.707106769f * fTemp223));
			float fTemp224 = fVec65[((IOTA - iTemp149) & 16383)];
			fVec66[0] = fTemp224;
			fRec7[0] = (fVec66[1] - ((fTemp152 * (fRec7[1] - fTemp224)) / fTemp153));
			fRec5[0] = fRec7[0];
			fVec67[(IOTA & 16383)] = ((0.707106769f * fTemp221) + (0.707106769f * fTemp223));
			fRec116[0] = (fSlow99 + (0.999899983f * (fRec116[1] + float((iSlow98 * iTemp0)))));
			float fTemp225 = (fRec116[0] + -1.49998999f);
			float fTemp226 = fVec67[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp225)))) & 16383)];
			fVec68[0] = fTemp226;
			float fTemp227 = std::floor(fTemp225);
			fRec115[0] = (fVec68[1] - (((fTemp227 + (2.0f - fRec116[0])) * (fRec115[1] - fTemp226)) / (fRec116[0] - fTemp227)));
			fRec6[0] = fRec115[0];
			float fTemp228 = ((fSlow2 * fRec5[1]) + (fSlow93 * fTemp220));
			float fTemp229 = ((fSlow2 * fTemp228) - (fSlow93 * fRec2[1]));
			float fTemp230 = ((fSlow2 * fRec6[1]) + (fSlow93 * fTemp222));
			float fTemp231 = ((fSlow2 * fTemp230) - (fSlow93 * fRec3[1]));
			fVec69[(IOTA & 16383)] = ((0.707106769f * fTemp229) - (0.707106769f * fTemp231));
			fRec117[0] = (fSlow101 + (0.999899983f * (fRec117[1] + float((iSlow100 * iTemp0)))));
			float fTemp232 = (fRec117[0] + -1.49998999f);
			float fTemp233 = fVec69[((IOTA - std::min<int>(8192, std::max<int>(0, int(fTemp232)))) & 16383)];
			fVec70[0] = fTemp233;
			float fTemp234 = std::floor(fTemp232);
			fRec4[0] = (fVec70[1] - (((fTemp234 + (2.0f - fRec117[0])) * (fRec4[1] - fTemp233)) / (fRec117[0] - fTemp234)));
			fRec2[0] = fRec4[0];
			fVec71[(IOTA & 16383)] = ((0.707106769f * fTemp229) + (0.707106769f * fTemp231));
			float fTemp235 = fVec71[((IOTA - iTemp162) & 16383)];
			fVec72[0] = fTemp235;
			fRec118[0] = (fVec72[1] - ((fTemp165 * (fRec118[1] - fTemp235)) / fTemp166));
			fRec3[0] = fRec118[0];
			fRec0[0] = ((fSlow2 * fRec2[1]) + (fSlow93 * fTemp228));
			fRec1[0] = ((fSlow2 * fRec3[1]) + (fSlow93 * fTemp230));
			output0[i0] = FAUSTFLOAT(((fSlow0 * fRec0[0]) + (fSlow102 * fTemp12)));
			output1[i0] = FAUSTFLOAT(((fSlow0 * fRec1[0]) + (fSlow102 * fTemp191)));
			iVec0[1] = iVec0[0];
			fRec15[1] = fRec15[0];
			fRec16[1] = fRec16[0];
			IOTA = (IOTA + 1);
	...
	#define FAUST_FILE_NAME "jpreverb.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("[01]Mix/earlyDiff", fHslider1, 0.70699999999999996f, 0.0f, 0.98999999999999999f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("[01]Mix/size", fHslider5, 1.0f, 0.5f, 3.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[01]Mix/t60", fHslider6, 1.0f, 0.10000000000000001f, 60.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("[01]Mix/damp", fHslider2, 0.0f, 0.0f, 0.999f, 0.0001f);
	FAUST_ADDHORIZONTALSLIDER("[01]Mix/wet", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[02]EQ/[00]level/lowX", fHslider11, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[02]EQ/[00]level/midX", fHslider10, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[02]EQ/[00]level/highX", fHslider7, 0.5f, 0.0f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("[02]EQ/[01]Xover/lowBand", fHslider9, 500.0f, 100.0f, 6000.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("[02]EQ/[01]Xover/highBand", fHslider8, 2000.0f, 1000.0f, 10000.0f, 0.10000000000000001f);
	FAUST_ADDHORIZONTALSLIDER("[03]Mod/mDepth", fHslider3, 0.10000000000000001f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("[03]Mod/mFreq", fHslider4, 2.0f, 0.0f, 10.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, earlyDiff, "[01]Mix/earlyDiff", fHslider1, 0.70699999999999996f, 0.0f, 0.98999999999999999f, 0.001f) \
		p(HORIZONTALSLIDER, size, "[01]Mix/size", fHslider5, 1.0f, 0.5f, 3.0f, 0.01f) \
		p(HORIZONTALSLIDER, t60, "[01]Mix/t60", fHslider6, 1.0f, 0.10000000000000001f, 60.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, damp, "[01]Mix/damp", fHslider2, 0.0f, 0.0f, 0.999f, 0.0001f) \
		p(HORIZONTALSLIDER, wet, "[01]Mix/wet", fHslider0, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, lowX, "[02]EQ/[00]level/lowX", fHslider11, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, midX, "[02]EQ/[00]level/midX", fHslider10, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, highX, "[02]EQ/[00]level/highX", fHslider7, 0.5f, 0.0f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, lowBand, "[02]EQ/[01]Xover/lowBand", fHslider9, 500.0f, 100.0f, 6000.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, highBand, "[02]EQ/[01]Xover/highBand", fHslider8, 2000.0f, 1000.0f, 10000.0f, 0.10000000000000001f) \
		p(HORIZONTALSLIDER, mDepth, "[03]Mod/mDepth", fHslider3, 0.10000000000000001f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, mFreq, "[03]Mod/mFreq", fHslider4, 2.0f, 0.0f, 10.0f, 0.01f) \
